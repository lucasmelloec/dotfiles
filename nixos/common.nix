...

{
  ...
  in {
    ...
    policies = {
      ...
      DisplayBookmarksToolbar = "newtab"; # alternatives: "always", "never" or "newtab"
      DisplayMenuBar = "default-off"; # alternatives: "always", "never", "default-off" or "default-on"
      ...
      Preferences = { 
        ...
        "browser.newtabpage.activity-stream.feeds.section.topstories" = falseAndLocked;
        "browser.newtabpage.activity-stream.feeds.snippets" = falseAndLocked;
        "browser.newtabpage.activity-stream.section.highlights.includePocket" = falseAndLocked;
        "browser.newtabpage.activity-stream.section.highlights.includeBookmarks" = falseAndLocked;
        "browser.newtabpage.activity-stream.section.highlights.includeDownloads" = falseAndLocked;
        "browser.newtabpage.activity-stream.section.highlights.includeVisited" = falseAndLocked;
